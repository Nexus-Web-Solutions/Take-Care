...
export function Gallery() {
  return (
    <div className="h-full w-full overflow-auto bg-take_care_bg">
      {/* <Collage /> */}
      <div className="flex items-end justify-center pb-12">
        ...
        >
          <div className="flex items-end justify-center pb-12 pt-10 text-5xl font-bold text-take_care_primary">
            Gallery
          </div>
